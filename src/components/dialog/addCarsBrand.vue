<template>
    <!-- dialog 
        子组件接收父组件的数据，通过属性接收
     -->
     <el-dialog title="新增车辆品牌" :visible.sync="dialogVisible" class="cars-dialog-conter" @close="close" @opened="opened" :close-on-click-modal="false">
